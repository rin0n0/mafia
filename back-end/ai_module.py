...
class AINarrator:
    ...
    def _get_user_query(self, event_type: str, event_data: Dict) -> str:
        ...
        queries = {
            ...
            "joke_voting_start": "Сейчас начнется шуточное голосование. Придумай и задай игрокам атмосферный вопрос (в поле 'summary'), ответом на который будет имя одного из них.",
